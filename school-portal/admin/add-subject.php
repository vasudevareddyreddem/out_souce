        ...
        <div class="col-md-12">
          ...
          <div class="box box-primary">
            <div class="box-header with-border">
              <h3 class="box-title">Add Classwise Subjects</h3>
            </div>
            <!-- /.box-header -->
            <!-- form start -->
            ...
            <form id="defaultForm" method="post" class="" action="add-teacher.php">
						...
						<div class="row">
							...
							<div class="col-md-3">
								<div class="form-group">
									<label class=" control-label">Subject Code (Optional)</label>
									<div class="">
										<input type="text" class="form-control" name="username" placeholder="Enter Class Name" />
									</div>
								</div>
							...
							<div class="col-md-3">
								<div class="form-group">
									<label class=" control-label">Book Name (Optional)</label>
									<div class="">
										<input type="text" class="form-control" name="username" placeholder="Enter Class Name" />
									</div>
								</div>
						...
						<br>
						 <div class="form-group">
                            <div class="pull-right">
								...
								<a href="subjects.php" type="submit" class="btn btn-warning" >Back</a>
