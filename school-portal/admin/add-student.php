          ...
          <div class="box box-primary">
            ...
            <form id="defaultForm" method="post" class="" action="add-student.php">
						...
						<div class="form-group">
                            ...
                            <div class="">
                                <input type="text" class="form-control" name="username" placeholder="Name of the Student" />
                            </div>
                        </div>
						<div class="form-group">
						...
						<div class="input-group date">
						  ...
						  <input type="text" class="form-control pull-right" id="datepicker" placeholder="Date of Birth" />
						</div>
						...
						<div class="form-group">
                            ...
                            <div class="">
                                <input type="text" class="form-control" name="" placeholder="Enter Current Address" />
                            </div>
                        </div>
							...
							<div class="row">
								<div class=" col-md-4">
									<div class="form-group">
										<div class="">
											<input type="text" class="form-control" name="email" placeholder="Enter City Name" />
										</div>
									</div>
								</div>
								<div class=" col-md-4">
								...
								<div class=" col-md-4">
									<div class="form-group">
										<div class="">
											<input type="text" class="form-control" name="email" placeholder="Enter Pincode" />
										</div>
									</div>
								</div>
						...
						<div class="form-group">
                            ...
                            <div class="">
                                <input type="password" class="form-control" name="confirmPassword" placeholder="Enter User Name " />
                            </div>
                        </div>
						<div class="row">
								<div class=" col-md-6">
						...
						<div class="row">
								<div class=" col-md-6">
									...
									<label class=" control-label">Class</label>
										<div class="">
											<input type="text" class="form-control" name="" placeholder="Enter Class" />
										</div>
									</div>
								</div>
								<div class=" col-md-6">
									...
									<label class=" control-label">Roll Number</label>
										<div class="">
											<input type="text" class="form-control" name="password" placeholder=" Enter roll Number" />
										</div>
									</div>
								</div>
							</div>
							...
							<div class="row">
								<div class=" col-md-6">
									...
									<label class=" control-label">Education</label>
										<div class="">
											<input type="text" class="form-control" name="" placeholder="Enter Education" />
										</div>
									</div>
								</div>
								<div class=" col-md-6">
									...
									<label class=" control-label">Profession</label>
										<div class="">
											<input type="text" class="form-control" name="password" placeholder=" Enter Profession" />
										</div>
									</div>
								</div>
							</div>
							<div class="row">
								...
								<div class=" col-md-6">
									...
									<label class=" control-label">Confirm Password</label>
										<div class="">
											<input type="text" class="form-control" name="password" placeholder=" Enter Confirm  password" />
										</div>
									</div>
								</div>
							</div>
