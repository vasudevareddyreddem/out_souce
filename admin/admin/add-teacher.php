						...
						<div class="row">
								<div class=" col-md-6">
									...
									<label class=" control-label">Date of Join</label>
										<div class="">
											<input type="text" class="form-control" name="" placeholder="Enter Date of Join" />
										</div>
									</div>
								</div>
								<div class=" col-md-6">
									<div class="form-group">
									<label class=" control-label">Date of Releaving</label>
										<div class="">
											<input type="text" class="form-control" name="password" placeholder=" Enter Date of Releaving" />
										</div>
									</div>
								</div>
							</div>
							<div class="row">
								...
								<div class=" col-md-4">
									...
									<label class=" control-label">Employee Code</label>
										<div class="">
											<input type="text" class="form-control" name="password" placeholder="Employee Code" />
										</div>
									</div>
								</div>
								<div class=" col-md-4">
									...
									<label class=" control-label">Working Hours</label>
										<div class="">
											<input type="text" class="form-control" name="password" placeholder=" Working Hours" />
										</div>
									</div>
								</div>
							</div>
						  ...
						  <div class="form-group">
                            <div class="col-lg-4 col-lg-offset-10">
                                <button type="submit" class="btn btn-primary" name="signup" value="Sign up">Add Teacher</button>
								<a href="teacher.php" type="submit" class="btn btn-warning" >Back</a>
